---
title: "Spectometer Regression With Only Phi Even Term" 
...
* **PRex_LHRS_combine_focal_420suggested.csv** :: Professor Nilanga 4.20 suggestion, add term P111 P101 P110 P201 P210 P211. Each term can not added seperatetly, using the following rule :: (theta == 1 or 2 and y ==0 or 1 when Phi == 1)

```{r message=FALSE, warning=FALSE}

focal_url = "./Data/PRex_LHRS/PRex_LHRS_combine_focal_420suggested.csv"
...
dataSet$wght = ifelse(dataSet$SieveColID <= 5, 1, 1)
