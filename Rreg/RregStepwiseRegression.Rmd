---
title: "Spectometer Regression With All Phi Term Stepwise Regression Models" 
...
train.phi.stepws = trainSet %>% select(-evtID, -runID, -CutID,-SieveRowID,-SieveColID,-bpmX,-bpmY,-targCalTh,-wght)  ## -targCalPh

full.model  <- lm(targCalPh~., data = train.phi.stepws)
