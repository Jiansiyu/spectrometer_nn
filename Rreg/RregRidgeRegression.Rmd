---
title: "Spectometer Regression With All Phi Term Ridge Regression Models" 
...
fit.phi   = cv.glmnet(as.matrix(train_X), as.matrix(train_y_phi), weights = as.matrix(cv.weight), nfolds = n.fold, alpha = 0)
```
